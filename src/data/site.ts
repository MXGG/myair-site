...
export const site = {
	en: {
		...
		footer: {
			...
			copyright: 'GRACE L2 Notes. Address: 1037 Luoyu Road, Hongshan District, Wuhan. Email: lilx@hust.edu.cn.',
			sections: 'Sections',
			resources: 'Resources',
			rss: 'RSS Feed',
		...
		search: {
			...
			items: [
				...
				{ title: 'Downloads', text: 'Software installer, release notes, and usage information.', href: '/downloads/' },
		...
		downloads: {
			...
			cardText:
				'The program provides a desktop-oriented workflow for Level-2 data preparation, Gaussian/Fan/DDK/HSAF filtering, EWH product synthesis, basin statistics, and result preview. Stable packages are distributed through the project release page.',
			button: 'Open download page',
			releaseHint: 'Latest verified package and version notes.',
			meta: [
	...
	zh: {
		...
		footer: {
			...
			copyright: 'GRACE L2 Notes. 地址：武汉市洪山区珞喻路 1037 号；邮箱：lilx@hust.edu.cn。',
			sections: '站点栏目',
			resources: '相关资源',
			rss: 'RSS 订阅',
			releases: 'GitHub Releases',
		...
		home: {
			...
			allArticles: '全部文章',
			releaseTitle: '软件发布',
			releaseText: '在下载页查看安装包、版本说明和软件使用信息。',
			releaseAction: '打开下载页',
		...
		search: {
			...
			items: [
				...
				{ title: '方法记录', text: 'Gaussian、Fan、PnMm、组合滤波、DDK、HSAF 和泄漏校正。', href: '/zh/methods/' },
				{ title: 'Gaussian 平滑滤波', text: '高阶噪声抑制、各向同性空间平滑、GAUSS_300。', href: '/zh/methods/gaussian/' },
				{ title: 'Fan 扇形滤波', text: '阶数与次数相关的各向异性空间滤波。', href: '/zh/methods/fan/' },
				{ title: 'PnMm 去相关滤波', text: '奇偶阶多项式去相关和南北条带削弱。', href: '/zh/methods/decorrelation/' },
				{ title: '组合滤波', text: 'PnMm 去相关与 Gaussian 或 Fan 平滑串联。', href: '/zh/methods/combined-filter/' },
				{ title: 'DDK 正则化滤波', text: '误差协方差、正则化约束和 DDK1–DDK8 产品。', href: '/zh/methods/ddk/' },
				{ title: 'HSAF / Hankel 谱分析滤波', text: '自适应条带模态识别与信号重构。', href: '/zh/methods/hsaf/' },
				{ title: '泄漏校正与质量验证', text: '尺度因子恢复、周边信号扣除和 Hydroweb 验证。', href: '/zh/methods/leakage-validation/' },
				{ title: '博客', text: '处理笔记和可复现工作流记录。', href: '/zh/blog/' },
				{ title: '下载', text: '软件安装包、版本说明与使用信息。', href: '/zh/downloads/' },
		...
		downloads: {
			...
			versionLabel: 'GRACE L2 Processing Software',
			cardTitle: '安装包与版本发布',
			cardText: '该程序面向 Level-2 数据准备、Gaussian/Fan/DDK/HSAF 滤波、等效水高产品合成、流域统计与图像预览等流程。稳定安装包通过项目发布页提供，本页面提供统一下载入口。',
			button: '打开下载页面',
			releaseHint: '最新安装包与版本说明。',
			meta: [
				['运行平台', 'Windows 桌面端'],
